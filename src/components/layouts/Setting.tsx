        ...
        <div className="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
          ...
          <div className="border border-dashed border-white-light dark:border-[#1b2e4b] rounded-md mb-3 p-3">
            ...
            <div className="mt-3">
              <select
                className="form-select border-primary text-primary"
                value={themeConfig.server}
                onChange={(e) => dispatch(switchServer(e.target.value))}
              >
                <option value=" ">Select Server</option>
                <option value="https://111movies.com">level-1</option>
                <option value="https://player.vidsrc.co/embed">level-2</option>
                <option value="https://vidfast.pro">level-3</option>
                <option value="https://moviesapi.club">level-4</option>
                <option value="https://vidlink.pro">level-5</option>
                <option value="https://www.vidstream.site/embed">
                  level-6
                </option>
                <option value="player.vidplus.to">level-7</option>
                <option value="https://vidsrc.rip/embed">level-8</option>
                <option value="https://player.videasy.net">level-1:1</option>
                <option value="https://vidora.su">level-9</option>
              </select>
            </div>
          </div>
        </div>
